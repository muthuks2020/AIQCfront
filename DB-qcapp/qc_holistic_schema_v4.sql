...
-- 2.7 Sampling Plan Details (Lot Size → Sample Size)
...
-- ================================================================================
-- MODULE 8: INSPECTION REPORTS (IR) — NEW DEDICATED TABLE
-- ================================================================================
...
-- ================================================================================
-- MODULE 9: STORE TRANSFER (Acceptance Flow) — NEW
-- ================================================================================
...
-- ================================================================================
-- MODULE 11: DELIVERY CHALLAN & DEBIT NOTES — NEW
-- ================================================================================
...
(8, 1, 1, 'SYSTEM'),     -- Admin → admin role
(1, 3, 1, 'SYSTEM'),     -- Rajesh → checker (QC Manager)
(2, 2, 1, 'SYSTEM'),     -- Priya → maker (Sr QC Inspector)
(3, 2, 1, 'SYSTEM'),     -- Anand → maker (QC Inspector)
(4, 4, 4, 'SYSTEM'),     -- Meera → approver (Finance)
(5, 7, 2, 'SYSTEM'),     -- Suresh → store_keeper
(6, 6, 5, 'SYSTEM'),     -- Karthik → gate_entry
(7, 3, 1, 'SYSTEM'),     -- Lakshmi → checker (QA Manager)
(7, 5, 1, 'SYSTEM');     -- Lakshmi also → viewer (regulatory oversight)
...
('CAT-ELEC',  'Electronic Components',  '⚡', 1),
('CAT-MECH',  'Mechanical Parts',       '⚙️', 2),
('CAT-OPT',   'Optical Components',     '🔬', 3),
('CAT-PKG',   'Packaging Materials',    '📦', 4),
('CAT-CHEM',  'Chemical & Consumables', '🧪', 5),
('CAT-RAW',   'Raw Materials',          '🏗️', 6);
...
(1, 'P-VIS-03', 'Cable Length',            'visual',     '1500 ± 50 mm',                         1,     1500, 1450, 1550, 1,     'measurement', 3),
(1, 'P-VIS-04', 'Housing Diameter',        'visual',     '38.0 ± 0.5 mm',                        1,     38.0, 37.5, 38.5, 1,     'measurement', 4),
-- B-SCAN Functional Stage parameters
(2, 'P-FUN-01', 'Frequency Response',      'functional', '3.5 ± 0.3 MHz',                        13,    3.5,  3.2,  3.8,  5,     'measurement', 1),
(2, 'P-FUN-02', 'Sensitivity (dB)',        'functional', '-6 dB bandwidth > 60%',                 NULL,  60,   60,   100,  5,     'measurement', 2),
(2, 'P-FUN-03', 'Impedance',              'functional', '50 ± 10 Ohm',                           11,    50,   40,   60,   4,     'measurement', 3),
...
(4, 'P-PCB-F2', 'Signal Output',          'functional', '3.3V ± 0.1V',                           9,     3.3,  3.2,  3.4,  4,     'measurement', 2),
-- Optical Lens
(5, 'P-OPT-01', 'Lens Diameter',          'visual',     '25.0 ± 0.1 mm',                         1,     25.0, 24.9, 25.1, 1,     'measurement', 1),
(5, 'P-OPT-02', 'Surface Clarity',        'visual',     'No inclusions, scratches, or haze',     NULL,  NULL, NULL, NULL, NULL,  'pass_fail', 2),
(5, 'P-OPT-03', 'Focal Length',           'visual',     '75 ± 2 mm',                              1,     75,   73,   77,   3,     'measurement', 3);
...
(1, 1, 'visual',     'Cable Length',            '1500 ± 50 mm',                         1,     1500, 1450, 1550, 1,              'Vernier Caliper 150mm', 'measurement',  2),
(1, 1, 'visual',     'Housing Diameter',        '38.0 ± 0.5 mm',                        1,     38.0, 37.5, 38.5, 1,              'Vernier Caliper 150mm', 'measurement',  3),
(1, 1, 'visual',     'Connector Type',          'BNC Male, gold plated',                NULL,  NULL, NULL, NULL, NULL,            NULL,                    'pass_fail',    4),
-- Transducer Functional
(1, 2, 'functional', 'Frequency Response',      '3.5 ± 0.3 MHz',                        13,    3.5,  3.2,  3.8,  5,              'Ultrasound Tester',     'measurement',  1),
(1, 2, 'functional', 'Sensitivity',             '-6 dB bandwidth > 60%',                 15,    60,   60,   100,  5,              'Ultrasound Tester',     'measurement',  2),
(1, 2, 'functional', 'Impedance',              '50 ± 10 Ohm',                           11,    50,   40,   60,   4,              'Digital Multimeter',    'measurement',  3),
...
(2, 4, 'functional', 'Signal Output Voltage',  '3.3V ± 0.1V',                           9,     3.3,  3.2,  3.4,  4,              'Digital Multimeter',    'measurement',  2);
...
(1, 3, 2, 'BSC-PCB-001', 'Main Control PCB Assembly', 25, 'NOS', 3, 'Functional Failure', '10 out of 25 PCBs failed electrical test - signal output voltage outside tolerance (measured 3.8V vs spec 3.3V ± 0.1V). Batch rejected per quality policy.', 3400.00, 85000.00);
